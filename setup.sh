...
if [ ! -e "./.gitignore" ]; then
        ...
        if [ -z "$LANG" ]; then
            ...
            echo "\n" >> .gitignore && curl https://www.toptal.com/developers/gitignore/api/macos,intellij,$LANG >> .gitignore && echo "\n#idea\n.idea" >> .gitignore && echo "\033[0;32mMake .gitignore using https://www.toptal.com/developers/gitignore/api/macos,intellij,$LANG\033[0m"
        fi
else
    ...
    if [ "$choice" = "y" ]; then
        ...
        if [ -z "$LANG" ]; then
            ...
            echo "\n" >> .gitignore && curl https://www.toptal.com/developers/gitignore/api/macos,intellij,$LANG >> .gitignore && echo "\n#idea\n.idea" >> .gitignore && echo "\033[0;32mUpdate .gitignore using https://www.toptal.com/developers/gitignore/api/macos,intellij,$LANG\033[0m"
        fi
    else
        echo "\033[0;32mNo changes made\033[0m"
    fi
